# Generated by Django 2.2.28 on 2022-07-20 10:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(db_index=True, max_length=255, unique=True, verbose_name='название')),
                ('measurement_unit', models.TextField(max_length=20, verbose_name='единица измерения')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pub_date', models.DateTimeField(auto_created=True, auto_now_add=True, verbose_name='дата создания')),
                ('name', models.TextField(db_index=True, max_length=255, unique=True, verbose_name='название')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.TextField(max_length=7, unique=True, validators=[django.core.validators.RegexValidator(regex='#[0-9,A-F]{6}')], verbose_name='цвет')),
            ],
            options={
                'ordering': ['name'],
            },
